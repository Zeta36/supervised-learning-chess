...
class Config:
    def __init__(self, config_type="mini"):
        ...
        if config_type == "mini":
            import supervised_learning_chess.configs.mini as c
        elif config_type == "normal":
            import supervised_learning_chess.configs.normal as c
        else:
...
class ResourceConfig:
    ...
    def create_directories(self):
        dirs = [self.project_dir, self.data_dir,
                self.model_dir, self.play_data_dir, self.log_dir]
        for d in dirs:
